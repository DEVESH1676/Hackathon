...
const MainLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-cyan-500/30 overflow-x-hidden text-balance">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-12">
            <section id="feed-root" className="min-h-[600px]">
              {React.cloneElement(children as React.ReactElement, { pipelineState: state })}
            </section>
