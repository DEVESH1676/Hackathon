...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/devesh/Hackathon/.gemini
                  → checks /home/devesh/Hackathon/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/devesh/Hackathon/.gemini/get-shit-done
                  → writes to /home/devesh/Hackathon/.gemini/get-shit-done/hooks/
...
@/home/devesh/Hackathon/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/devesh/Hackathon/.gemini/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/devesh/Hackathon/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/devesh/Hackathon/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/devesh/Hackathon/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
