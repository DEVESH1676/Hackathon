...
- **Global scope**: `/home/devesh/Hackathon/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/devesh/Hackathon/.gemini/notes/`)
...
2. Glob `/home/devesh/Hackathon/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/devesh/Hackathon/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/devesh/Hackathon/.gemini/notes/` — works in any directory
